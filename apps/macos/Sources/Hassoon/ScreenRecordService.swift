...
final class ScreenRecordService {
    ...
    private let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "screenRecord")
...
private final class StreamRecorder: NSObject, SCStreamOutput, SCStreamDelegate, @unchecked Sendable {
    let queue = DispatchQueue(label: "com.moeghashim.hassoon.screenRecord.writer")
