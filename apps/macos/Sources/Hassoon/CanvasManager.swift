...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Hassoon/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__hassoon__/a2ui/").absoluteString + "?platform=macos"
    }
