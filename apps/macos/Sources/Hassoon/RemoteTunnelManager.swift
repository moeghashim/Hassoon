...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous Hassoon run already has an SSH listener on the expected port (common after restarts),
