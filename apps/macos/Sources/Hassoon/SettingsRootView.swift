...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .hassoonSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? HassoonPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? HassoonPaths.stateDirURL.path
...
extension Notification.Name {
    static let hassoonSelectSettingsTab = Notification.Name("hassoonSelectSettingsTab")
}
