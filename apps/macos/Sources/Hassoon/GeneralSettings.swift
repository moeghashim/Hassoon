        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading, spacing: 18) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    SettingsToggleRow(
                        title: "Hassoon active",
                        subtitle: "Pause to stop the Hassoon gateway; no messages will be processed.",
                    ...
                    SettingsToggleRow(
                        ...
                        subtitle: "Automatically start Hassoon after you sign in.",
                        binding: self.$state.launchAtLogin)

                    SettingsToggleRow(
                        title: "Show Dock icon",
                        subtitle: "Keep Hassoon visible in the Dock instead of menu-bar-only mode.",
                ...
                HStack {
                    Spacer()
                    Button("Quit Hassoon") { NSApp.terminate(nil) }
    ...
    private var cliInstaller: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if let status = cliStatus {
                ...
                Text("Symlink \"hassoon\" into /usr/local/bin and /opt/homebrew/bin for scripts.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                    .lineLimit(2)
            }
...
extension GeneralSettings {
    ...
    private func revealLogs() {
        ...
        Looked for hassoon logs in /tmp/hassoon/.
...
extension GeneralSettings {
    static func exerciseForTesting() {
        ...
        state.remoteProjectRoot = "/tmp/hassoon"
        state.remoteCliPath = "/tmp/hassoon"
        ...
        view.cliInstallLocation = "/usr/local/bin/hassoon"
