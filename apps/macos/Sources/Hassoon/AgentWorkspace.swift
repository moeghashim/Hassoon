...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return HassoonConfigFile.defaultWorkspaceURL() }
