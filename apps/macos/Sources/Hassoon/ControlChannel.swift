...
final class ControlChannel {
    ...
    private let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "control")
    ...
    private func friendlyGatewayMessage(_ error: Error) -> String {
           ...
           urlErr.code == .dataNotAllowed // used for WS close 1008 auth failures
        {
            ...
            return
                "Gateway rejected token; set HASSOON_GATEWAY_TOKEN in the mac app environment " +
...
extension Notification.Name {
    static let controlHeartbeat = Notification.Name("hassoon.control.heartbeat")
    static let controlAgentEvent = Notification.Name("hassoon.control.agent")
}
