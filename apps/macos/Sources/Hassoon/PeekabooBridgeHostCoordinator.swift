...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "PeekabooBridge")

    private var host: PeekabooBridgeHost?
    private var services: HassoonPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = HassoonPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.hassoonSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.hassoonSocketPath, privacy: .public)")
    }
...
@MainActor
private final class HassoonPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "com.moeghashim.hassoon.peekaboo")
