...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com.moeghashim/hassoon") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com.moeghashim/hassoon")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://steipete.me")
                AboutLinkRow(icon: "bird", title: "Twitter", url: "https://twitter.com.moeghashim")
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "HassoonBuildTimestamp") as? String else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "HassoonGitCommit") as? String ?? "unknown"
    }
