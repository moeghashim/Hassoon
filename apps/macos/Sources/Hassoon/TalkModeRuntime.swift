...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.moeghashim.hassoon", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [HassoonChatMessage] = messages.compactMap { item in
