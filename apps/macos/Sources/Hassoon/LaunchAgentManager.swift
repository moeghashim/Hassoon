...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/com.moeghashim.hassoon.plist")
    }
    ...
    private static func writePlist(bundlePath: String) {
        ...
        <dict>
          <key>Label</key>
          <string>com.moeghashim.hassoon</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/Hassoon</string>
          </array>
