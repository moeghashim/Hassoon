...
enum HassoonConfigFile {
    private static let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "config")

    static func url() -> URL {
        HassoonPaths.configURL
    }

    static func stateDirURL() -> URL {
        HassoonPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        HassoonPaths.workspaceURL
    }
