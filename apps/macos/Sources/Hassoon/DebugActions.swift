...
enum DebugActions {
    private static let verboseDefaultsKey = "hassoon.debug.verboseMain"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Hassoon", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".hassoon/hassoon.json")
        guard
