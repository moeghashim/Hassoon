...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.moeghashim.hassoon", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Hassoon windows, but below the system’s pop-up menus.
