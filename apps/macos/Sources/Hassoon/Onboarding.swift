...
enum UIStrings {
    static let welcomeTitle = "Welcome to Hassoon"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "hassoon.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: HassoonOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: HassoonChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "ln -sf '\(bundlePath)/Contents/Resources/Relay/hassoon' /usr/local/bin/hassoon"
    }
