...
public struct CanvasShowResult: Codable, Sendable {
    /// Session directory on disk (e.g. `~/Library/Application Support/Hassoon/canvas/<session>/`).
...
public let controlSocketPath =
    FileManager.default
        ...
        .appendingPathComponent("Library/Application Support/hassoon/control.sock")
        .path
