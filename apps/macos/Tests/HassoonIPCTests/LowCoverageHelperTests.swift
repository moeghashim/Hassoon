...
struct LowCoverageHelperTests {
    ...
    @Test func gatewayLaunchAgentHelpers() {
        let keyBind = "HASSOON_GATEWAY_BIND"
        let keyToken = "HASSOON_GATEWAY_TOKEN"
        ...
        #expect(GatewayLaunchAgentManager._testGatewayExecutablePath(bundlePath: "/App") == "/App/Contents/Resources/Relay/hassoon")
