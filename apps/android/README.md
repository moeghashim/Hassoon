## Hassoon Node (Android) (internal)

Modern Android node app: connects to the **Gateway-owned bridge** (`_hassoon-bridge._tcp`) over TCP and exposes **Canvas + Chat + Camera**.
