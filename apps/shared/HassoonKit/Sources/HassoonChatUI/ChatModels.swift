...
public typealias HassoonPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias HassoonPlatformImage = UIImage
#endif

public struct HassoonChatUsageCost: Codable, Hashable, Sendable {
...
public struct HassoonChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: HassoonChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(HassoonChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct HassoonChatMessageContent: Codable, Hashable, Sendable {
...
public struct HassoonChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [HassoonChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: HassoonChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [HassoonChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: HassoonChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(HassoonChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([HassoonChatMessageContent].self, forKey: .content) {
...
public struct HassoonChatHistoryPayload: Codable, Sendable {
...
public struct HassoonChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct HassoonChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct HassoonAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct HassoonChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct HassoonGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct HassoonPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: HassoonPlatformImage?
...
public struct HassoonChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
