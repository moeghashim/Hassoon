...
@MainActor
public struct HassoonChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: HassoonChatViewModel,
    ...
    private var visibleMessages: [HassoonChatMessage] {
        let base: [HassoonChatMessage]
    ...
    private func mergeToolResults(in messages: [HassoonChatMessage]) -> [HassoonChatMessage] {
    ...
    private func isToolResultMessage(_ message: HassoonChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: HassoonChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: HassoonChatMessage) -> String {
