...
public enum HassoonCanvasA2UICommand: String, Codable, Sendable {
...
public struct HassoonCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct HassoonCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
