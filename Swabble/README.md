...
- **Wake word**: Default `hassoon` (aliases `claude`), optional `--no-wake` bypass.
...
// Package.swift
dependencies: [
    .package(url: "https://github.com.moeghashim/swabble.git", branch: "main"),
],
targets: [
...
```json
{
  ...
  "wake": {"enabled": true, "word": "hassoon", "aliases": ["claude"]},
  "hook": {
    "command": "",
    "args": [],
