...
if [[ -z "$version_content" ]]; then
  echo "<h2>Hassoon $VERSION</h2>"
  echo "<p>Latest Hassoon update.</p>"
  echo "<p><a href=\"https://github.com.moeghashim/hassoon/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
