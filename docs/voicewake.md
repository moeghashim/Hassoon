...
Hassoon treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.hassoon/settings/voicewake.json`

Shape:

```json
{ "triggers": ["hassoon", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
