...
```bash
hassoon nodes camera list --node <id>            # list camera ids
hassoon nodes camera snap --node <id>            # prints MEDIA:<path>
hassoon nodes camera snap --node <id> --max-width 1280
hassoon nodes camera snap --node <id> --delay-ms 2000
hassoon nodes camera snap --node <id> --device-id <id>
...
hassoon nodes camera clip --node <id> --device-id <id>
hassoon nodes camera clip --node <id> --no-audio
```
