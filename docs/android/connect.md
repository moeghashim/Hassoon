---
summary: "Runbook: connect/pair the Android node to a Hassoon Gateway and use Canvas/Chat/Camera"
read_when:
...
```bash
hassoon nodes invoke --node "<Android Node>" --command canvas.navigate --params '{"url":"http://<gateway-hostname>.local:18793/__hassoon__/canvas/"}'
```
...
The A2UI host lives at `http://<gateway-host>:18793/__hassoon__/a2ui/`.
