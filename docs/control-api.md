...
**Deprecated (historical):** superseded by the WebSocket Gateway protocol (`hassoon gateway`, see `docs/architecture.md` and `docs/gateway.md`).
...
- `health`: returns the gateway health snapshot (same shape as `hassoon health --json`).
