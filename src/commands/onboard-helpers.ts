...
import { CONFIG_PATH_HASSOON } from "../config/config.js";
...
export function summarizeExistingConfig(config: HassoonConfig): string {
  const rows: string[] = [];
...
export async function handleReset(
  ...
  await moveToTrash(CONFIG_PATH_HASSOON, runtime);
